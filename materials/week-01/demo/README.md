# Session 1 demo — files, folders, first run
...
that IS the planted-lie moment of session 1. All outputs on the slides
are from real runs of these files.

The chatbot moment ("where did my file go?") is scripted in prompt.md;
the fallback screencast follows it verbatim.
